...
namespace KeyAuth
{
    public class api
    {
        ...
        /// </summary>
        /// <param name="Cleaner">Application Name</param>
        /// <param name="0GpVPDYRBo">Your OwnerID, can be found in your account settings.</param>
        /// <param name="70b1a5a096799e79326a39838e18b7558ba529d89e6a6ed9ea3a44411172e3d4">Application Secret</param>
